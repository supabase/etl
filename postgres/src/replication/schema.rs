...
mod tests {
    ...
    fn test_postgres_type_to_string() {
        assert_eq!(postgres_type_to_string(&Type::BOOL), "BOOL");
        assert_eq!(postgres_type_to_string(&Type::INT4), "INT4");
        assert_eq!(postgres_type_to_string(&Type::INT8), "INT8");
        assert_eq!(postgres_type_to_string(&Type::TEXT), "TEXT");
        assert_eq!(postgres_type_to_string(&Type::VARCHAR), "VARCHAR");
        assert_eq!(postgres_type_to_string(&Type::TIMESTAMP), "TIMESTAMP");
        assert_eq!(postgres_type_to_string(&Type::TIMESTAMPTZ), "TIMESTAMPTZ");
        assert_eq!(postgres_type_to_string(&Type::DATE), "DATE");
        assert_eq!(postgres_type_to_string(&Type::TIME), "TIME");
        assert_eq!(postgres_type_to_string(&Type::BYTEA), "BYTEA");
        assert_eq!(postgres_type_to_string(&Type::UUID), "UUID");
        assert_eq!(postgres_type_to_string(&Type::JSON), "JSON");
        assert_eq!(postgres_type_to_string(&Type::JSONB), "JSONB");
        assert_eq!(postgres_type_to_string(&Type::FLOAT4), "FLOAT4");
        assert_eq!(postgres_type_to_string(&Type::FLOAT8), "FLOAT8");
    }

    #[test]
    fn test_string_to_postgres_type() {
        assert_eq!(string_to_postgres_type("BOOL"), Type::BOOL);
        assert_eq!(string_to_postgres_type("INT4"), Type::INT4);
        assert_eq!(string_to_postgres_type("INT8"), Type::INT8);
        assert_eq!(string_to_postgres_type("TEXT"), Type::TEXT);
        assert_eq!(string_to_postgres_type("VARCHAR"), Type::VARCHAR);
        assert_eq!(string_to_postgres_type("TIMESTAMP"), Type::TIMESTAMP);
        assert_eq!(string_to_postgres_type("TIMESTAMPTZ"), Type::TIMESTAMPTZ);
        assert_eq!(string_to_postgres_type("DATE"), Type::DATE);
        assert_eq!(string_to_postgres_type("TIME"), Type::TIME);
        assert_eq!(string_to_postgres_type("BYTEA"), Type::BYTEA);
        assert_eq!(string_to_postgres_type("UUID"), Type::UUID);
        assert_eq!(string_to_postgres_type("JSON"), Type::JSON);
        assert_eq!(string_to_postgres_type("JSONB"), Type::JSONB);
        assert_eq!(string_to_postgres_type("FLOAT4"), Type::FLOAT4);
        assert_eq!(string_to_postgres_type("FLOAT8"), Type::FLOAT8);
    ...
    fn test_type_conversion_roundtrip() {
        ...
        for pg_type in types {
            let type_string = postgres_type_to_string(&pg_type);
    ...
    #[test]
    fn test_type_string_conversion_comprehensive() {
        let test_types = vec![
            (Type::BOOL, "BOOL"),
            (Type::CHAR, "CHAR"),
            (Type::INT2, "INT2"),
