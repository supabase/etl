...
/// Labels: `table`.
pub const ETL_CLICKHOUSE_DDL_DURATION_SECONDS: &str = "etl_clickhouse_ddl_duration_seconds";
...
pub const ETL_CLICKHOUSE_INSERT_DURATION_SECONDS: &str = "etl_clickhouse_insert_duration_seconds";
