...
CPU_REQUEST="${CPU_REQUEST:-${MAC_CPU_REQUEST:-125m}}"
CPU_LIMIT="${CPU_LIMIT:-${MAC_CPU_LIMIT:-250m}}"
MEMORY_REQUEST="${MEMORY_REQUEST:-${MAC_MEMORY_REQUEST:-250Mi}}"
MEMORY_LIMIT="${MEMORY_LIMIT:-${MAC_MEMORY_LIMIT:-300mi}}"
