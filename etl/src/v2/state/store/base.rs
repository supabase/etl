...
pub trait StateStore {
    ...
    fn get_table_replication_state(
        &self,
        table_id: TableId,
    ) -> impl Future<Output = Result<Option<TableReplicationPhase>>> + Send;
    ...
    fn get_table_replication_states(
        &self,
    ) -> impl Future<Output = Result<HashMap<TableId, TableReplicationPhase>>> + Send;
    ...
    fn load_table_replication_states(&self) -> impl Future<Output = Result<usize>> + Send;
