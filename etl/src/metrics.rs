...
pub(crate) fn register_metrics() {
    REGISTER_METRICS.call_once(|| {
        ...
        describe_counter!(
            ...
            Unit::Count,
            "Total number of heartbeat failures (connection or emission errors)"
        );
        ...
        describe_counter!(
            ...
            Unit::Count,
            "Total number of connection attempts to the primary for heartbeat"
        );
