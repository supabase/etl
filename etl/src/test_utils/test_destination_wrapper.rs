    ...
    D: Destination + Send + Sync + Clone + 'static,
{
    ...
    async fn write_events(
        ...
        tokio::spawn(async move {
            ...
            // Propagate completion to the outer apply loop before notifying test
            // waiters so a waiter-triggered shutdown cannot race ahead of a
            // durably completed flush.
            async_result.send(result);
