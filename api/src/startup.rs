...
use crate::{
    ...
    routes::{
        ...
        pipelines::{
            CreatePipelineRequest, CreatePipelineResponse, GetPipelineStatusResponse, GetReplicationStatusResponse,
            ReadPipelineResponse, ReadPipelinesResponse, TableReplicationStatus, TableReplicationUiState,
            UpdatePipelineImageRequest, UpdatePipelineRequest, create_pipeline, delete_pipeline,
            get_pipeline_status, get_pipeline_replication_status, read_all_pipelines, read_pipeline, start_pipeline,
            stop_all_pipelines, stop_pipeline, update_pipeline, update_pipeline_image,
        },
        sources::{
