...
pub async fn validate_destination_pipeline(
    ...
    failures.extend(validate_destination_internal(ctx, destination_config, false).await?);
    failures.extend(validate_pipeline_internal(ctx, pipeline_config, false).await?);
